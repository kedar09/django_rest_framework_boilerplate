...
def get_all_authors(request):
    if request.method == 'GET':
        ...
        return Response(author_list_serializer.data, status=status.HTTP_200_OK)
...
def get_author_by_id(request, pk):
    ...
    if request.method == 'GET':
        ...
        return Response(author_details_serializer.data, status=status.HTTP_200_OK)


@api_view(['PUT'])
def update_author_by_id(request, pk):
    try:
        author_details = Author.objects.get(pk=pk)
    except Author.DoesNotExist:
        return Response(status=status.HTTP_404_NOT_FOUND)
...
@api_view(['DELETE'])
def delete_author_by_id(request, pk):
    try:
        author_details = Author.objects.get(pk=pk)
    except Author.DoesNotExist:
        return Response(status=status.HTTP_404_NOT_FOUND)
...
def get_books(request):
    if request.method == 'GET':
        ...
        return Response(books_and_authors_list_serializer.data, status=status.HTTP_200_OK)
...
def get_book_by_id(request, pk):
    ...
    if request.method == 'GET':
        ...
        return Response(book_and_author_details_serializer.data, status=status.HTTP_200_OK)
...
def update_book_by_id(request, pk):
    try:
        ...
        return Response(status=status.HTTP_404_NOT_FOUND)
    if request.method == 'PUT':
        update_book_serializer = BookSerializer(
